...
// zooAnimals.forEach(animal) => lowCaseAnimalNames.push(`Name: ${animal.animal_name}, Scientific: $ {animal.scientific_name}`)
...
const lowCase = zooAnimals.map(animal => animal.animal_name.toLocaleLowerCase());
console.log(lowCase);
